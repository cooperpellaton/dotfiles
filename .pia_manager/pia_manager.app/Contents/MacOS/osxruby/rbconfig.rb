...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/tmp/ruby-deploy")
  ...
  CONFIG["configure_args"] = " '--prefix=/tmp/ruby-deploy' '--disable-install-doc' 'CFLAGS=-arch i386 -mmacosx-version-min=10.5' 'LDFLAGS=-arch i386 -mmacosx-version-min=10.5' 'CXXFLAGS=-arch i386 -mmacosx-version-min=10.5'"
  ...
  CONFIG["EXTDLDFLAGS"] = ""
  CONFIG["warnflags"] = "-Wall -Wextra -Wno-unused-parameter -Wno-parentheses -Wno-long-long -Wno-missing-field-initializers -Wpointer-arith -Wwrite-strings -Wdeclaration-after-statement -Wshorten-64-to-32 -Wimplicit-function-declaration"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-arch i386 -mmacosx-version-min=10.5"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D_XOPEN_SOURCE -D_DARWIN_C_SOURCE $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -arch i386 -mmacosx-version-min=10.5 -L/usr/local/lib"
  CONFIG["CFLAGS"] = "-arch i386 -mmacosx-version-min=10.5 -pipe"
  CONFIG["CC"] = "gcc"
  ...
  CONFIG["host"] = "x86_64-apple-darwin10.8.0"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin10.8.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin10.8.0"
